...
from transformers import (
    Trainer, Seq2SeqTrainer, Adafactor, AdamW,
    PretrainedConfig, __version__
)
...
from transformers.trainer_utils import (
    speed_metrics, EvalLoopOutput, denumpify_detensorize,
    TrainOutput, set_seed, get_last_checkpoint,
    HPSearchBackend, EvalPrediction
)
from transformers.trainer_pt_utils import (
    find_batch_size, nested_numpify, nested_truncate,
    nested_concat, IterableDatasetShard, get_parameter_names
)
